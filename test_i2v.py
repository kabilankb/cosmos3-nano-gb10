"""Cosmos3-Nano image-to-video test on GB10."""
import json
import torch
...
json_prompt = json.load(open(f"{ASSETS}/example_i2v_prompt.json"))
negative_prompt = json.load(open(f"{ASSETS}/negative_prompt.json"))
image = load_image(f"{ASSETS}/example_i2v_input.jpg")
...
print("Pipeline loaded. Generating video from image...")
...
out_path = f"{OUTPUT}/cosmos3_nano_i2v_test.mp4"
